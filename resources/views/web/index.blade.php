        ...
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
              ...
              {{-- ここに星評価を記述 --}}
              <p><span class="samuraimart-star-rating" data-rate="{{round($recommend_product->reviews->avg('score') * 2) / 2}}"></span>{{round($recommend_product->reviews->avg('score') * 2, 1) / 2}}</p>
            ...
            <div class="row">
              <div class="col-12">
                <p class="samuraimart-product-label mt-2">
                  ...
                  {{-- ここに星評価を記述 --}}
                  <p><span class="samuraimart-star-rating" data-rate="{{round($recently_product->reviews->avg('score') * 2) / 2}}"></span>{{round($recently_product->reviews->avg('score') * 2, 1) / 2}}</p>
